...
<!-- ملاحظات الترجمة: أُبقي على sidebar_label وtitle دون ترجمة لأنهما معرّفات تقنية | أُبقي على أسماء المؤلفين بالإنجليزية | أُبقي على كتلة الشيفرة دون ترجمة | kept EN: Asset — اسم فئة برمجية | kept EN: Apache License — اسم رخصة رسمي -->