...
<!-- ملاحظات الترجمة: [Agentification ترجمت وصفيًا إلى "فئة التوكيل" مع الاحتفاظ بالمصطلح الأصلي بين قوسين] | [kept EN: SQL — اسم لغة استعلام معيارية] | [kept EN: CSV — اختصار تقني معروف] | [kept EN: Apache License — اسم رخصة علامة تجارية] -->