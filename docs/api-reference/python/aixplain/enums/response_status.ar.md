...
### كائنات ResponseStatus

```python
class ResponseStatus(Text, Enum)
```

<!-- ملاحظات الترجمة: [ترجمة "Asset Enum" إلى "تعداد الأصول"] | [ترجمة "Objects" إلى "كائنات" وفق المسرد] | [kept EN: ResponseStatus — اسم فئة برمجي] | [kept EN: أسماء المؤلفين — أسماء أعلام لا تُترجم] | [kept EN: Apache License — اسم رخصة معروف] -->