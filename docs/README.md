<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="assets/aixplain-logo-light.svg">
    <source media="(prefers-color-scheme: light)" srcset="assets/aixplain-logo-dark.svg">
    <img src="assets/aixplain-logo-dark.svg" alt="aixplain" width="420">
  </picture>
</p>
...
<p align="center">
  <img src="assets/aixplain-agentic-os-architecture.svg" alt="aixplain Agentic OS architecture — governed execution loop (Planner, Orchestrator, Inspector, Bodyguard) over the infrastructure services, deployable on cloud, on-prem, edge, and local" width="100%">
</p>
