...
def test_team_agent_llm_parameter_preservation(resource_tracker, run_input_map, TeamAgentFactory):
    ...
    supervisor_llm = ModelFactory.get("6646261c6eb563165658bbb1")  # Anthropic Claude 3.5 Sonnet v1
    mentalist_llm = ModelFactory.get("6646261c6eb563165658bbb1")  # Anthropic Claude 3.5 Sonnet v1
    ...
    team_agent = TeamAgentFactory.create(
        ...
        llm_id="6646261c6eb563165658bbb1",  # Still required even with custom LLMs
