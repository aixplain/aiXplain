...
# option 1
sentiment_analysis = pipeline.sentiment_analysis(assetId="6172874f720b09325cbcdc33")

# option 2
sentiment_analysis = SentimentAnalysis(pipeline=pipeline, assetId="6172874f720b09325cbcdc33")
