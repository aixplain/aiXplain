...
class BenchmarkFactory:
    ...
    def _validate_create_benchmark_payload(cls, payload):
        ...
        payload["metrics"] = [
            {"id": metric_id, "configurations": metric_config}
            for metric_id, metric_config in clean_metrics_info.items()
        ]
        return payload
    ...
    def create(
        ...
        try:
            ...
            payload = {
                ...
                "metrics": [
                    {"id": metric.id, "configurations": metric.normalization_options} for metric in metric_list
                ],
