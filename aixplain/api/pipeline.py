...
class ReferencelessAudioGenerationMetric(
    Asset[ReferencelessAudioGenerationMetricInputs, ReferencelessAudioGenerationMetricOutputs]
):
    """
...
class ReferencelessTextGenerationMetric(
    Asset[ReferencelessTextGenerationMetricInputs, ReferencelessTextGenerationMetricOutputs]
):
    """
...
class ReferencelessTextGenerationMetricDefault(
    Asset[ReferencelessTextGenerationMetricDefaultInputs, ReferencelessTextGenerationMetricDefaultOutputs]
):
    """
...
class Pipeline(BasePipeline):
    ...
    def document_information_extraction(
        self, assetId: Union[str, asset.Asset], *args, **kwargs
